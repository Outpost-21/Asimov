    ...
    public class Comp_EnergySource : ThingComp
    {
        ...
        public override IEnumerable<FloatMenuOption> CompFloatMenuOptions(Pawn selPawn)
        {
            ...
            if (energyNeed != null)
            {
                ...
                if (thingCount > 0)
                {
                    FloatMenuOption floatMenuOption = new FloatMenuOption("Asimov.ConsumeEnergySource".Translate(parent.LabelCap), () => selPawn.jobs.TryTakeOrderedJob(new Verse.AI.Job(AsimovDefOf.Asimov_ConsumeEnergySource, new LocalTargetInfo(parent)) { count = thingCount }), MenuOptionPriority.Default, null, parent);
